...
fn read_bool_setting(name: &str) -> bool {
    match name {
        ...
        "update_experimental" => get_setting().update_experimental,
        ...
        "keep_only_latest_experimental" => get_setting().keep_only_latest_experimental,
...
fn write_bool_setting(name: &str, value: bool) {
    match name {
        ...
        "update_experimental" => set_setting().update_experimental = value,
        ...
        "keep_only_latest_experimental" => set_setting().keep_only_latest_experimental = value,
